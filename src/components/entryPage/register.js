        ...
        return (
            <div>
                <form>
                    ...
                    <br />
                    <input type="text" id="fullName" onChange={this.nameChangeHandler} value={this.state.usernameString} placeholder="Name" style={{ marginBottom: "5px", width: "100%" }} className="form-control form-control-lg" />
                    <br />
                    <label htmlFor="surname" className="labelStyle"><b>Surname</b></label>
                    <br />
                    <input type="text" id="surname" onChange={this.usernameChangeHandler} value={this.state.nameString} placeholder="Surname" style={{ marginBottom: "5px", width: "100%" }} className="form-control form-control-lg" />
                    <br />
                    <label htmlFor="registerEmail" className="labelStyle"><b>Email</b></label>
                    <br />
                    <input type="email" id="registerEmail" onChange={this.emailChangeHandler} value={this.state.emailString} placeholder="Email Address" style={{ marginBottom: "5px", width: "100%" }} className="form-control form-control-lg" />
                    <br />
                    <label htmlFor="registerPass" className="labelStyle"><b>Password</b></label>
                    <br />
                    <input type="password" id="registerPass" onChange={this.passwordChangeHandler} value={this.state.passwordString} placeholder="Min 6 characters" style={{ marginBottom: "15px", width: "100%" }} className="form-control form-control-lg"/>
                    <br />
