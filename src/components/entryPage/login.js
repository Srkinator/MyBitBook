        ...
        return (
            <div>
                <form onSubmit={this.handleLoginRequest}>
                    ...
                    <br />
                    <input type="email" id="loginEmail" onChange={this.getEmailInput} onKeyPress={this.handleKeyPress} value={this.state.emailInput} placeholder="Email" className="form-control form-control-lg" style={{ marginBottom: "5px", width: "100%" }} />
                    <br />
