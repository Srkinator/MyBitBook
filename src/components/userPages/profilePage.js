...
class UserProfile extends Component {
            ...
            <div>
                ...
                >
                    ...
                    <div className="row">
                        ...
                        <div className="col profilePageModal">
                            <form>
                                <input type="button" value="Close" onClick={this.closeModal} className="updateProfileCloseButton updateProfileUpdateButton btn btn-success btn-lg"/>
                                <div>
                                ...
                                <input type="button" value="Update" onClick={this.updateProfile} className="updateProfileUpdateButton btn btn-info btn-lg"/>
    ...
    displayEditProfileButton() {
        return (
            <input type="button" value="Edit Profile " id="editProfileData" onClick={this.openModal} className="btn btn-info btn-lg loginProfileButton editProfileButton" />
        );
    }
